			...
			case 1:
				...
				switch (tipo) {
					case 1 -> {
						...
						produto.cadastrar(new ProdutoDigital(produto.gerarID(), nomeProduto, valor, qnt, tipo, chaveDigital));
					}
					case 2 -> {
						System.out.println("Digite o lote do produto: ");
						lote = leia.nextInt();
						produto.cadastrar(
								new ProdutoFisico(produto.gerarID(), nomeProduto, valor, qnt, tipo, lote));
					}
				}
